--==================================================
-- HomeGui.lua
-- Updated with Floating Button
-- Based on existing stable layout
--==================================================
...
--========================
-- Tab System Logic
-- (all as original from your stable file)
--========================
...
local function selectKiller()
    ...
    local function updateHitbox()
        ...
        hitboxBtn.BackgroundColor3 = hitboxEnabled and Color3.fromRGB(0,180,120) or Color3.fromRGB(120,70,180)
    end
    updateHitbox()
    ...
    local function updateStalk()
        ...
        stalkBtn.BackgroundColor3 = stalkEnabled and Color3.fromRGB(0,180,120) or Color3.fromRGB(120,70,180)
    end
    updateStalk()
